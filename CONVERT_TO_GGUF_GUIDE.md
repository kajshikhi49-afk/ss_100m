...
ADAPTER_PATH = "/content/drive/MyDrive/qwen_nctb_final"
...
print("📁 Location: /content/qwen_nctb_bangla_fp16.gguf")

# File size check করুন
import os
file_size = os.path.getsize("/content/qwen_nctb_bangla_fp16.gguf")
print(f"📊 File size: {file_size / (1024**3):.2f} GB")
```

---

### 📌 Cell 4: Quantize to Q4_0 (Smaller Size)

```python
print("🔄 Quantizing to Q4_0 (smaller size for Android)...")

# Quantize to Q4_0 (ছোট size, ভালো performance)
!./llama.cpp/llama-quantize \
    /content/qwen_nctb_bangla_fp16.gguf \
    /content/qwen_nctb_bangla_q4_0.gguf \
    q4_0

print("✅ Q4_0 quantization complete!")
print("📁 Location: /content/qwen_nctb_bangla_q4_0.gguf")

# File size check করুন
import os
fp16_size = os.path.getsize("/content/qwen_nctb_bangla_fp16.gguf")
q4_size = os.path.getsize("/content/qwen_nctb_bangla_q4_0.gguf")

print(f"\n📊 Size Comparison:")
print(f"  - FP16:  {fp16_size / (1024**3):.2f} GB (high quality)")
print(f"  - Q4_0:  {q4_size / (1024**2):.2f} MB (optimized for mobile)")
print(f"  - Saved: {(fp16_size - q4_size) / (1024**3):.2f} GB")
```
...
# Copy করুন
print("📤 Copying files...")
shutil.copy("/content/qwen_nctb_bangla_fp16.gguf", f"{output_folder}/")
shutil.copy("/content/qwen_nctb_bangla_q4_0.gguf", f"{output_folder}/")

print("✅ Files copied to Google Drive!")
print(f"📁 Location: {output_folder}")
print("\nFiles available:")
print("  1. qwen_nctb_bangla_fp16.gguf (High quality, larger)")
